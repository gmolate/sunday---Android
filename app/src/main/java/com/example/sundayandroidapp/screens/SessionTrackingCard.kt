        ...
        Column(
            ...
            Row(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(text = stringResource(R.string.iu_per_min_template, rate), color = Color.White, fontWeight = FontWeight.Bold, fontSize = 24.sp)
                }
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = if (isTracking) Color(0xFFF44336) else Color(0xFF4CAF50)), // Red for stop, Green for start
                shape = RoundedCornerShape(12.dp)
            ) {
                Text(
                    text = if (isTracking) stringResource(R.string.stop_button) else stringResource(R.string.start_button),
                    color = Color.White,
                    fontSize = 20.sp,
